...
function Sidebar() {
  ...
  return (
    <div className="space-y-2 min-w-max max-w-lg">
      <div className="bg-white dark:bg-[#1D2226] rounded-lg overflow-hidden 
        relative flex flex-col items-center text-center border-gray-300 dark:border-emerald-500">
          <div className="relative w-full h-14">
            <Image src="https://rb.gy/i26zak" alt="image" layout="fill" priority/>
          </div>
          <Avatar
            onClick={signOut}
          ...
          <div className="mt-5 py-4 space-x-0.5">
            <h4 className="hover:underline decoration-purple-700 underline-offset-1
              cursor-pointer">
              {session?.user?.name}
            </h4>
