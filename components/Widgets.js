...
function Widgets({articles}) {
  return (
    <div className="hidden xl:inline space-y-2">
      <div className="bg-white dark:bg-[#1D2226] py-2.5 rounded-lg space-y-2 
        ...
        <div className="space-y-1">
          {articles.slice(0,5).map((article) => (
            <div key={article.url} className="flex space-x-2 items-center cursor-pointer
              hover:bg-black/10 dark:hover:bg-black/20 px-2.5 py-1">
      ...
      <div className="bg-white dark:bg-[#1D2226] w-11/12 h-64 px-2.5 rounded-lg
