...
function Post({ post, modalPost }) {
  ...
  return (
    <div className={`bg-white dark:bg-[#1D2226] 
      ${modalPost ? "rounded-r-lg" : "rounded-lg"} space-y-2 py-2.5 border
      ...
      <div className="flex justify-evenly items-center dark:border-t
        dark:border-gray-600/80 mx-2.5 pt-2 text-black/60 dark:text-white/75">
        {modalPost ? (
